...
contract ProfileTokenURI {
    ...
    function getProfileTokenURI(
        ...
        string memory usernameWithAtSymbol = string(abi.encodePacked('@', username, '.fren'));
        return
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            ...
                            _getSVGImageBase64Encoded(usernameWithAtSymbol, imageURI),
    ...
    function _getSVGImageBase64Encoded(string memory usernameWithAtSymbol, string memory imageURI)
        internal
        pure
        ...
        return
            Base64.encode(
                abi.encodePacked(
                    ...
                    Strings.toString(_handleLengthToFontSize(bytes(usernameWithAtSymbol).length)),
